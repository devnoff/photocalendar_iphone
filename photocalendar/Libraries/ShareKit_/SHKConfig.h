...
#define SHKFacebookKey @"217489064994975"
#define SHKFacebookSecret @"ea02a547215111a1edc386105c3b4fd0"
 ...
 */
#define SHKTwitterConsumerKey		@"5f5XXrA0vlC9nwwoslmXA"
#define SHKTwitterSecret			@"bLFssaxCmQg6CwhFlF5rWpmGJOyDTmQG8OjnHtxkHec"
#define SHKTwitterCallbackUrl		@"http://cultstory.com/apps/photoplace/" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"cultstory" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
...
#define SHKBitLyLogin				@"noff"
#define SHKBitLyKey					@"R_a046210216c66439b6b3d904d9ff95ba"
...
#define SHKFlickrConsumerKey @"81f6f9e9b81ebb13a78d9297bad034f1"	// The consumer key
#define SHKFlickrSecretKey @"e4503544d8e7b503"		// The secret key
#define SHKFlickrCallbackUrl @"http://www.flickr.com/"	// The user defined callback url
