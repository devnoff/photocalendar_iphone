...
#import "KalDate.h"
#import "KalPrivate.h"
//#import "DetailAnniversaryViewController.h"
...
@synthesize dataSource, delegate,tableView,currDate=_currDate;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (_currDate) {
        [self showAndSelectDate:[self.currDate NSDate]];
    }
