	...
	for(SKPaymentTransaction *transaction in transactions) {
		switch (transaction.transactionState) {
			...
			case SKPaymentTransactionStatePurchased:
                ...
                NSLog(@"Item was successfully purchased!");
                /////////
                /////
                /////
                
                [_delegate didSuccessPurchase];
                
                
                [Flurry logEvent:@"Upgrade Purchased"];
			...
			case SKPaymentTransactionStateRestored:
                ...
                NSLog(@"Verified tha user has already paid for this item");
                /////////
                /////
                /////
			...
			case SKPaymentTransactionStateFailed:
                ...
                NSLog(@"User Cancel or error occured");
                
                [_delegate didFailedPurchase];
                
                NSLog(@"Transaction error occured %@", transaction.error);
				
				if (transaction.error.code == SKErrorPaymentCancelled) {
					// A transaction error occurred, so notify user.
                    NSLog(@"Transaction error occured %@", transaction.error);
                    [_delegate didCancelledPurchase];
				}
